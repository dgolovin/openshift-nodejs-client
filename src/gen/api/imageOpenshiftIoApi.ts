...
export enum ImageOpenshiftIoApiApiKeys {
    BearerToken,
}

export class ImageOpenshiftIoApi {
    ...
    public setApiKey(key: ImageOpenshiftIoApiApiKeys, value: string) {
        (this.authentications as any)[ImageOpenshiftIoApiApiKeys[key]].apiKey = value;
    }
    ...
    public async getAPIGroup (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: V1APIGroup;  }> {
        const localVarPath = this.basePath + '/apis/image.openshift.io/';
